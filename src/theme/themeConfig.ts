...
const baseColors = {
  ...
  textOnSvg: '#696D7B', // Цвет текста на svg
    ...
    footer: {
      background: '#FFFFFF', // Цвет фона футера
      bottom: '#23221E', // Цвет нижней части футера
      text: '#2A3242', // Цвет текста в футере
    },
  },
  dark: {
    ...
    footer: {
      background: '#161719', // Цвет фона футера
      bottom: '#0D0E0F', // Цвет нижней части футера
      text: '#D5CDBD', // Цвет текста в футере
    },
  },
};
