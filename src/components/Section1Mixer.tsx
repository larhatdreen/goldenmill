...
const items = [
  {
    number: '01',
    textKey: 'diagrams.millMixer.mainFeatures.features.1'
  },
  {
    number: '02',
    textKey: 'diagrams.millMixer.mainFeatures.features.2'
  },
  {
    number: '03',
    textKey: 'diagrams.millMixer.mainFeatures.features.3'
  },
  {
    number: '04',
    textKey: 'diagrams.millMixer.mainFeatures.features.4'
  }
];
...
function GMFeaturesSVG() {
  ...
  const barHeight = svgHeight - topPadding - bottomPadding - 20;
  const barWidth = 0.5;
  ...
  return (
    <svg
      viewBox={`0 0 ${isLG ?'900' : '800'} ${svgHeight}`}
      className='w-[100%] tablet:w-[60%]'
      height="auto"
      style={{ display: 'block', transform: isLG ? 'translate(15%, 18%)' : '' }}
    >
      {/* Вертикальный бар */}
      ...
      >
        <svg className='hidden tablet:block '>
          ...
          <foreignObject className='text-center' x='7' y='580' width='230' height='25'>
            ...
            >
              {t('diagrams.millMixer.mainFeatures.descriptionBg')}
            </span>
          </foreignObject>
        </svg>
        ...
        <foreignObject x={35} y={200} width={250} height={80}>
          ...
          >
            {t('diagrams.millMixer.mainFeatures.subtitle')}
          </text>
        </foreignObject>
