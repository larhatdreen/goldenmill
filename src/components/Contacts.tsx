    ...
    <>
      ...
      <section className='w-full h-auto px-[30px] md:px-[100px] gap-y-6 max-w-[1920px]'>
        <div className={`${!isLG ? 'hidden' : ''}`}>
          ...
          <span className="absolute w-[258px] left-[208px] top-[116px] font-['Bebas_Neue'] text-[17px] text-[#C0BFBD] tracking-widest text-center">
            {t('contacts.descriptionBg')}
          </span>
          <span className="absolute w-[258px] left-[208px] top-[654px] font-['Bebas_Neue'] text-[17px] text-[#C0BFBD] tracking-widest text-center">
          ...
          <div className='absolute left-[200px] top-[200px] flex flex-col items-start'>
            ...
            <span className="relative left-[40px] md:text-[24px] lg:text-[26px] font-[AdventProLight] text-[29px] text-[#D5CDBD]">
        ...
        <div className={`${!isLG ? '' : 'float-right'}`} style={{paddingTop: '90px'}}>
          <div>
            <span className="font-['Bebas_Neue'] text-[40px] md:text-[60px] lg:text-[65px] text-[#82653F] leading-[100%]">
              {t('contacts.requisites.title')}
            </span>
            <div className='flex flex-col mt-4 justify-between'>
              <span className='text-[#acacac] text-[18px] md:text-[20px] lg:text-[23px] font-[AdventProLight] ml-1'>
