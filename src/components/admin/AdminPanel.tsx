...
const AdminPanel = () => {
      ...
      <>
        <Box 
          sx={{
            ...
            p: { xs: 1.5, sm: 2, md: 3 },
            backgroundImage: 'linear-gradient(rgba(26, 26, 26, 0.9), rgba(26, 26, 26, 0.9)), url("/img/bg-pattern.png")',
  ...
  return (
    <Box sx={{ 
      ...
      right: 0,
      bottom: 0,
      backgroundImage: 'linear-gradient(rgba(26, 26, 26, 0.95), rgba(26, 26, 26, 0.95)), url("/img/bg-pattern.png")',
      backgroundSize: 'cover',
      backgroundPosition: 'center',
      backgroundRepeat: 'no-repeat',
    }}>
