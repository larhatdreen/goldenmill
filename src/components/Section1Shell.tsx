...
const items = [
  {
    number: '01',
    text: 'Усиленная конструкция смеситель-кондиционера GM гарантирует равномерное и стабильное смешивание компонентов даже при работе с тяжёлыми, влажными и труднообрабатываемыми материалами, обеспечивая высокое качество готового продукта.',
  },
  {
    number: '02',
    text: 'С упором на удобство эксплуатации: наличие обслуживающего люка позволяет быстро получить доступ к внутренним элементам, а конструкция с легко съёмными лопастями значительно упрощает их демонтаж и замену.',
  },
  {
    number: '03',
  ...
  {
    number: '04',
    text: 'Опционально: оснащение автоматической дозировки воды и жидкости, обеспечивающей максимально точную подачу благодаря интеграции контроллера и высокоэффективной форсунки ProMinent',
  }
];
